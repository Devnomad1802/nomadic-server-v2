...
export const newBooking = async (req, res) => {
  ...
  try {
    ...
    const newBooking = new Bookings({
      ...
      // ── populate analytics-friendly typed fields (safe reads from existing data) ──
      totalAmount: Number(req.body.selectedValue) || 0,
      travelers: Number(req.body.travelers) || undefined,
      tripName: req.body.paymentDetail?.title,
      gst: Number(req.body.gst) || undefined,
      discount: Number(req.body.discount) || undefined,
