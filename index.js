...
import HostPortalRoutes from "./routes/hostPortal.js";
import HostChatRoutes from "./routes/hostChat.js";
...
app.use("/api/host-portal", HostPortalRoutes);
app.use("/api/host-chat", HostChatRoutes);
